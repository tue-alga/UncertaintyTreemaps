 ...
 * @author msondag
 */
public class SplitTreeMapUncertainty implements TreeMapGenerator {
    ...
    private Map<DataMap, Rectangle> generateLevel(List<DataMap> dataMaps, Rectangle inputR) {
        ...
        if (inputR.getHeight() >= inputR.getWidth()) {
            if (DataMap.getTotalSize(list1) > DataMap.getTotalSize(list2)) {
                //l1 is largest, put it at the bottom
                ...
                //l2 is largest, put it at the bottom
